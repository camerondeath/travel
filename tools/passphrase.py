...
Writes the SHA-256 into site.css's sibling site.js, so the phrase itself is
never committed. Everyone already unlocked keeps working only if the phrase is
...
new, n = re.subn(r"const PASSPHRASE_HASH = '[^']*';", f"const PASSPHRASE_HASH = '{h}';", src, count=1)
if not n:
    sys.exit("PASSPHRASE_HASH line not found in site.js")
